...
#define HANDSCANNER_WIFI_SSID "your-wifi-name"
#define HANDSCANNER_WIFI_PASSWORD "your-wifi-password"
#define HANDSCANNER_BEARER_TOKEN "your-home-assistant-long-lived-access-token"
#define HANDSCANNER_OTA_PASSWORD "choose-a-strong-ota-password"
